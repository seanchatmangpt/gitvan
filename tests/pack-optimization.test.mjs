...
import { PackCache, PackOptimizer, PackProfiler } from '../src/pack/optimization/index.mjs';
...
describe('Pack Optimization System', () => {
  ...
  describe('PackOptimizer', () => {
    ...
    test('should generate consistent step fingerprints', () => {
      ...
      const step1 = { type: 'file', target: 'a.txt', action: 'copy', src: 'a.txt' };
      const step2 = { type: 'file', target: 'a.txt', action: 'copy', src: 'a.txt' };
      const step3 = { type: 'file', target: 'b.txt', action: 'copy', src: 'b.txt' };
  ...
  describe('Integration Tests', () => {
    test('should work together for complete optimization', async () => {
      ...
      const manifest = {
        provides: {
          templates: [
            { target: 'component.vue', src: 'component.njk' }
          ],
          files: [],
          jobs: []
        }
