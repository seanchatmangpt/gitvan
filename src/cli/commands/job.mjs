 ...
 */
const scheduleSubcommand = defineCommand({
  meta: {
    name: "schedule",
 ...
 * Unschedule a job
 */
const unscheduleSubcommand = defineCommand({
  meta: {
    name: "unschedule",
 ...
 * Start the scheduler
 */
const startSchedulerSubcommand = defineCommand({
  meta: {
 ...
 * Stop the scheduler
 */
const stopSchedulerSubcommand = defineCommand({
  meta: {
    name: "stop-scheduler",
 ...
 */
const schedulerStatusSubcommand = defineCommand({
  meta: {
 ...
 */
const autoScheduleSubcommand = defineCommand({
  meta: {
    name: "auto-schedule",
