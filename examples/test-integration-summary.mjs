...
console.log(
  "│   ├── events/path-changed/src/[...slug].mjs → triggers on src/ changes"
);
console.log(
  "│   └── events/tag/semver.mjs → triggers on semantic version tags"
);
...
console.log(
  "├── ✅ Can be triggered by path changes (path-changed/src/[...slug].mjs)"
);
...
console.log("");
console.log(
  "The unrouting system integrates perfectly with GitVan's event system!"
);
