 ...
 * They follow the test-fix-verify loop mandated by CLAUDE.md
 */
...
export default defineJob({
  ...
  describe('6. Job Execution', () => {
    beforeEach(() => {
      ...
      // Create template
      writeFileSync('templates/changelog.njk', `# Changelog
...
{% endfor %}`)
  ...
  describe('8. Event System', () => {
    ...
    it('should list discovered events', () => {
      writeFileSync('events/message/release.mjs', 'export default { job: "docs/changelog" }')
...
{% endfor %}`)
      ...
      // Create job
      writeFileSync('jobs/docs/changelog.mjs', `
...
export default defineJob({
  ...
  async run () {
    ...
    it('should handle errors gracefully', () => {
      ...
      mkdirSync('jobs/docs', { recursive: true })
      writeFileSync('jobs/docs/bad.mjs', `
export default {
  run: async () => {
