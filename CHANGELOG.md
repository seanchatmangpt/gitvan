...
### Added
- autonomous WIP cleanup by agent swarm
- Phase 2 - @unrdf full integration (hooks, validation, CRUD routes)
- Foundation spike - v5.0 @unrdf-based architecture
- Hook up Nitro tasks to JobRegistry integration
- Implement Testing utilities & harness (80/20 Phase 1)
- Implement Composables ecosystem patterns (Phase 1 - 80/20)
- Implement Oxigraph backend integration - Phase 1 (80/20)
- implement Dark Matter query optimization with 80/20 methodology
- implement SHACL shapes validation (80/20 Phase 1)
- implement Phase 1 hooks deepening with async support, composite predicates, and context enrichment
- implement streaming change feeds with 80/20 methodology
- implement Phase 1 Federation with peer discovery and event sync
- implement Knowledge Engine N3 rules foundation (80/20 methodology)
- implement Core RDF caching layer with 10x+ speedup
- Complete Nitro v5 + RDF Phases 2-8 Big Bang Implementation (80/20)
- Phase 1 - Complete RDF Config Management System Integration
- Complete Phase 1-3 UnRDF integration across all 10 capabilities
- Implement Turtle format management system (Phase 3 Week 17-20)
- Implement declarative SHACL validation for workflows, hooks, events, and configs
...
### Changed
- Integrate actual @unrdf APIs into core store
- Consolidate JobRegistry with define-job.mjs - Phase 1 Quick Win
- Eliminate all remaining RDF wrapper imports and identify anti-patterns
- Add @unrdf packages and establish hooks migration foundation
- Update graph and turtle composables to use @unrdf/core
- Remove unnecessary wrapper and meta-infrastructure composables
- Remove all RDF wrappers - use @unrdf/kgc-4d directly
- Use @unrdf/kgc-4d with correct API versions
- Fail fast on unrdf unavailability - no fallbacks
- remove redundant RDF libraries, use unrdf as single RDF source
...
### Fixed
- Nitro daemon plugin imports and middleware - enable daemon startup
...
### Documentation
- add Forward Deployment OS portfolio context
- update CHANGELOG.md for v4.0.1
- update CHANGELOG.md for v4.0.1
- Add complete session summary for v5.0 foundation sprint
- Add comprehensive Phase 2 @unrdf integration guide
- update CHANGELOG.md for v4.0.1
- Add honest unrdf implementation status
- Add truthful assessment of daemon validation
- Final Completion Summary - GitVan v5.0.0 Production Ready
- Complete Session Summary - Strategic Transformation Plan Ready
- Strategic Decision - GitVan v5 Nitro Daemon Architecture
- Phase 1 Execution Summary - Ready for Phase 2 Launch
- Add comprehensive UnRDF integration analysis for all 10 capabilities
- add session completion summary - GitVan v4.0.2 fully assessed and ready
- explain GitVan paradigm shift - why git-native RDF architecture enables new category of automation
- identify 25+ latent JTBDs enabled by git-native RDF architecture
- add comprehensive JTBD benchmarks across all stakeholders
- update CHANGELOG.md for v4.0.1
- add RDF library consolidation summary - unrdf is now single RDF source
- add v4.0.2 complete delivery summary with release recommendation
- add exhaustive v4.0.2 benchmark suite with 100+ test cases
- add comprehensive v4.0.2 TPS + JTBD release readiness assessment
