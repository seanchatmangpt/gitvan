...
export interface TemplateComposable {
  ...
  renderToFile(template: string, out: string, data?: Record<string, any>): { path: string; bytes: number }
  env: any
}
...
export interface ExecComposable {
  ...
  tmpl(spec: { template: string; out?: string; data?: any; autoescape?: boolean; paths?: string[] }): JobResult
}
...
export function useTemplate(opts?: { autoescape?: boolean; paths?: string[] }): TemplateComposable
...
// Runtime
export function runJobWithContext(ctx: JobContext, jobMod: any, payload?: any): Promise<JobResult>