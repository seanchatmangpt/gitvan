...
`;
  ...
  afterAll(() => {
    // DISABLED: This cleanup was deleting test directories aggressively
    // and could potentially delete the wrong directory if testDir is not properly set
    // execSync(`rm -rf ${testDir}`);
    console.log(
      `⚠️ Test cleanup disabled for safety. Test directory: ${testDir}`
    );
  });
