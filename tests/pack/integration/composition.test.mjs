...
const mockPackData = {
  "nodejs-base": {
    ...
    compose: { order: 1 },
    provides: {
      templates: [{ src: "package.json.njk", target: "package.json" }],
  ...
  "database-postgres": {
    ...
    provides: {
      templates: [
        ...
        {
          src: "migrations/001_initial.sql.njk",
          target: "migrations/001_initial.sql",
        },
      ],
    },
    dependencies: {
...
async function testConflictHandling() {
  ...
  try {
    ...
    if (!validation.valid) {
      ...
      console.log(
        "❌ Conflict detection failed - should have detected conflicts\n"
      );
